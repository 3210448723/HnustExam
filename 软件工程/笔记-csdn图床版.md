...
1. 主要内容来源于老师画的重点和ppt；由于ppt知识点不详细，部分内容参考了《软件设计师教程》
1. 由于老师划重点不详细，笔记总体来说只是猜测哪些会考
2. ★超级重点；※补充内容，不一定重要；▲之前卷子出过题
2. 不要忽视了小标题，内容之间的关系也可能会出题（如：XX包括哪些？两个知识点之间的关系？）
2. 软工没怎么学通透，总结的不太清晰；有些知识点是东拼西凑加上个人理解而成
...
软件工程(Software Engineering)是指导计算机软件开发和维护的工程学科，它采用工程的概念、原理、技术和方法来开发和维护软件，把经过时间考验而证明正确的管理技术和当前能够得到的最好的技术方法结合起来，以经济地开发出高质量的软件并进行有效的维护。
...
软件的生命周期(Software Life cycle Model)：软件从定义、开发、使用和维护，直到最终被废弃的这个漫长时期。
...
![image-20230104213140455](https://img-blog.csdnimg.cn/9f2d08872d094ab9be5c0f7156518eea.jpeg)
...
![image-20230104214405712](https://img-blog.csdnimg.cn/569d792cf1114e7abf1f9140fd62d42d.jpeg)
...
![image-20230104214648791](https://img-blog.csdnimg.cn/7021ead5380f4b05b09aa81e95f546b9.jpeg)
...
![image-20230104213519536](https://img-blog.csdnimg.cn/7859410e43b048ada4dd887586ac4753.jpeg)
...
以用例和风险驱动，以架构为核心，迭代并且增量；与统一建模语言(UML)紧密结合。

##### 阶段★

![image-20230104212113489](https://img-blog.csdnimg.cn/60cdf1db188340db8fe320f540ee14f8.jpeg)
...
![image-20230105200003000](https://img-blog.csdnimg.cn/c42975eb32e0459aa9f9f0940be8be40.jpeg)
...
![image-20230129103323044](https://img-blog.csdnimg.cn/5ecc7f4b18c1447dbd7c906f232ee52e.jpeg)
...
![image-20230129204547511](https://img-blog.csdnimg.cn/f3016273663a46d9958ce9adb385ba99.jpeg)
...
![image-20230129203703769](https://img-blog.csdnimg.cn/6ace1dccfceb41be9a7551245501d517.jpeg)
...
![image-20230129114356514](https://img-blog.csdnimg.cn/8fc83768c7164b61914b8830efe66862.jpeg)
...
![image-20230129115542776](https://img-blog.csdnimg.cn/5009abe50bc04987bd15b8bcf1125e13.jpeg)
...
1. 考务处理系统0层图中加工1的分解是根据业务处理流程来确定的。分析考务处理系统的功能需求和0层图，将加工1分解成3个子加工：检查报名表、编准考证号和登记考生。加工1分解而成的子图如图（c）所示。
   ...
   ![image-20230129120330824](https://img-blog.csdnimg.cn/837a8893b8cf4765936f629cc4d8829b.jpeg)

2. 采用同样的方法画出加工2分解的DFD子图，如图（d）所示。

   ![image-20230129120408863](https://img-blog.csdnimg.cn/86b07ce7467e4174bbffc5596782d1a0.jpeg)
...
1. 用SA方法画出下列问题的顶层和0层数据流图。某运动会管理系统接受来自运动员的报名单、裁判的比赛项目及项目成绩，产生运动员号码单发送给运动员，项目参加者发送给裁判，单项名次、团体名次发送给发布台。 该系统有两部分功能： 
   ...
   ![img](https://img-blog.csdnimg.cn/8aaaf3153aec474c98e95b4ebdb3f7bc.jpeg)
...
2. 某培训中心要研制一个计算机管理系统。它的业务是：
   ...
   1. 对以上问题画出数据流图。
      ...
      ![img](https://img-blog.csdnimg.cn/839354727a1e4c91ba701435ba85d17a.jpeg)

   2. 画出该培训管理的软件结构图。

      ![img](https://img-blog.csdnimg.cn/9841bacda3154ffb935801c27b0afc6d.jpeg)
...
![image-20230131150241394](https://img-blog.csdnimg.cn/d6a5978cf31f40c499665280074e5e32.jpeg)
...
![image-20230105203742419](https://img-blog.csdnimg.cn/1263b722ac5e4413a52b8218acdbb502.jpeg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/e9e621251ee74792b9c25514488b542c.jpeg)
...
* 代码表现：成员变量
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/ccdc626255f24f2fb9a8047b3d9bb465.jpeg)

* 关联类

  和类一样，关联也可以有自己的属性和操作。此时，这个关联实际上是个关联类（association class）

  ![在这里插入图片描述](https://img-blog.csdnimg.cn/bea92010309749dfb2abd47ca3bf5e5b.jpeg)
...
* 格式
  ...
  聚合关系中的整体和部分之间用带空心菱形箭头的连线连接，箭头指向整体。  ![在这里插入图片描述](https://img-blog.csdnimg.cn/56b4eb0720dd4ea1a3af78eccf5a7393.jpeg)
...
* 格式
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/f564e5007f684544983880672c4bae80.jpeg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/50d8f38a0f17405b8813f3c65a56b467.jpeg)

###### 类关系由弱到强次序及表示

![在这里插入图片描述](https://img-blog.csdnimg.cn/bc463f657cbf49ba930f1cd30638494f.jpeg)
...
1. 一家图书馆藏有书籍、杂志、小册子、电影录像带、音乐CD、录音图书磁带和报纸等出版物，供读者借阅。这些出版物有出版物名、出版者、获得日期、目录编号、书架位置、借出状态和借出限制等属性，并有借出、收回等公共服务。此外这些出版物还存在特有属性，如：书籍有作者属性、杂志有日期属性、小册子有作者属性、电影录像带有电影名属性、音乐CD有演员名属性、录音图书磁带有作者属性，报纸有日期属性。请为图书馆馆藏出版物建立对象模型。
   ...
   ![image-20230129202950096](https://img-blog.csdnimg.cn/66f23ebfa8024e6ab8df9a42a44cb074.jpeg)
...
![img](https://img-blog.csdnimg.cn/3462f7303cd0452f836e3f5aad3272ab.jpeg)

###### 包含关系（include）

![img](https://img-blog.csdnimg.cn/83165b7f2ecb4cd4b9d2424f5a52beaa.jpeg)
...
![img](https://img-blog.csdnimg.cn/7b01c87ee46c476089ffbf285ab6603f.jpeg)
...
![img](https://img-blog.csdnimg.cn/9867fcad8cf340389ce293294ce9c9a9.jpeg)
...
* 用例图
  ...
  ![image-20230105202651092](https://img-blog.csdnimg.cn/17d196600d5a40c09a962ebbc7cbd2fc.jpeg)

* 用例描述

  * 基本事件流

    ![image-20230105210629937](https://img-blog.csdnimg.cn/fa858b1b32f047989e6e290467c96e92.jpeg)

    ![image-20230105210817431](https://img-blog.csdnimg.cn/3eea7f59904f4d84adcd3636eedb481a.jpeg)
...
1. 复印机工作的状态转换图★
   ...
   ![image-20230107094812663](https://img-blog.csdnimg.cn/aac953e6e42f4ad7b9a2df32e169ffbf.jpeg)

2. ControlPanel类的状态图（某个系统中针对某个类画出其状态转换图）

   ![image-20230107095204271](https://img-blog.csdnimg.cn/79538d78452b4cd1896d0617b1a64eb4.jpeg)
...
![image-20230107095606552](https://img-blog.csdnimg.cn/7902a21bbd064fffaa37908b262cf1a3.jpeg)

#### [活动图（了解）](https://blog.csdn.net/neusoft2016/article/details/117412480)
...
|   名称    |                             解释                             |                              图                              |
| :-------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| 初始节点  |  标记业务流程的开始，有且只有一个初始状态，用实心的圆点表示  |     ![img](https://img-blog.csdnimg.cn/2ddd50223bf54e54a2148669bb1303de.jpeg)      |
| 终止节点  | 表示业务流程的终止，可以有一个或多个用一个实心圆外加一个圆圈表示 |     ![img](https://img-blog.csdnimg.cn/12caa15229f6492b9b289b58ec414fc0.jpeg)      |
|   活动    |                     业务流程中的执行单元                     |     ![img](https://img-blog.csdnimg.cn/d039286e01cd4948a0061891c0ba7ace.jpeg)      |
| 判断/合并 | 根据某个条件进行决策，执行不同的流程分支。合并指的是两个或多个控制路径在此汇合的情况。合并和判断常常成对使用。在任何执行中每次直走一条，不同路径间互斥 |     ![img](https://img-blog.csdnimg.cn/a2a09e63bf7d4b8693f7ad383790c98e.jpeg)      |
| 分叉/结合 | 分叉用于表示将一个控制流分成两个或者多个并发运行的分支；结合用来表示并行分支在此得到同步，先完成的控制流需要再次等待，只有当所有的控制流都到达结合点，控制才能继续向下进行 | ![img](https://img-blog.csdnimg.cn/8416f6b46da84c7e8149684d00284202.jpeg) |
|   转换    | 当一个活动结束时，控制流会马上传递给下一个活动节点，在活动图中称之为”转换“，用一条带箭头的直线来表示 |     ![img](https://img-blog.csdnimg.cn/0cf3a359e2b844e0a374084b63fd206b.jpeg)      |
|   泳道    | 代表了一个特定的类、人、部分、层次等等对象的职责区，每个泳道代表特定含义的状态职责的部分。在活动图中，每个活动只能明确的属于一个泳道，泳道明确的表示了哪些活动是由哪些对象进行的。 |               ![img](https://img-blog.csdnimg.cn/246976140f7d48e980236255bf0e122a.jpeg)               |
...
![image-20230107204000695](https://img-blog.csdnimg.cn/fa7b3186581e42248e445d81179897cb.jpeg)

* 定义

  标志一个模块内**各个元素彼此结合的紧密程度**，它是**信息隐藏和局部化**概念的自然扩展。简单地说，理想内聚的模块只做一件事情。
...
![image-20230107203204368](https://img-blog.csdnimg.cn/b644d811f57d45d89ca02e284efde1e2.jpeg)
...
![image-20230107202655999](https://img-blog.csdnimg.cn/fa18a00e1d4f464b9daa802ff2f3180f.jpeg)

* 定义

  耦合性是程序结构中各个**模块之间相互依赖的度量**，它取决于各个模块之间接口的复杂程度、调用模块的方式以及哪些信息通过接口。

* 对于耦合，尽量使用非直接耦合、数据耦合和特征耦合，少用控制耦合和外部耦合 限制使用公共耦合，完全不用内容耦合
...
![image-20230107202202225](https://img-blog.csdnimg.cn/aa34796009a94d6a83c3e63b7c10dabc.jpeg)
...
* 类型
  ...
  ![image-20230107202309401](https://img-blog.csdnimg.cn/48c38ef5e05f4a35b0ec54b56e4741ae.jpeg)
...
![image-20230107205212986](https://img-blog.csdnimg.cn/a05ade4eb725408b8c4eb0d368947413.jpeg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/59406143ca0e418a8370b267c5580512.jpeg)
